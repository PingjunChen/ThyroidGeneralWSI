...
def annotate_images(data_dir, cur_set, cur_cat, slide_level):
    ...
    l2_annotate_dir = os.path.join(data_dir, "L4ImgOverlap", cur_set, cur_cat)
    ...
    for cur_slide in slide_list:
        ...
        for key in region_dict.keys():
            ...
            cv2.putText(slide_img, cur_label, tl_pos, cv2.FONT_HERSHEY_SIMPLEX, 2, (148,24,32), 2, cv2.LINE_AA)
